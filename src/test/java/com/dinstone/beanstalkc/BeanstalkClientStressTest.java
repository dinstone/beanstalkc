...
public class BeanstalkClientStressTest {
	...
	public void testStrees00() {
		DefaultBeanstalkClient client = new DefaultBeanstalkClient(
				new Configuration());
		...
		System.out.println("common case[1thread * 300time=300] takes "
				+ (et - st) + "ms");
	}
	...
	public void testStrees10() {
		...
		try {
			...
			System.out
					.println("this case[single client per thread(30thread * 10time=300)] take "
							+ (anyEnd - anyStart) + " ms");
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	...
	public void testStrees11() {
		...
		try {
			...
			long anyEnd = System.currentTimeMillis();
			System.out
					.println("this case[single client per thread(10thread * 30time=300)] take "
							+ (anyEnd - anyStart) + " ms");
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	...
	public void testStrees12() {
		...
		try {
			...
			long anyEnd = System.currentTimeMillis();
			System.out
					.println("this case[single client per thread(3thread * 100time=300)] take "
							+ (anyEnd - anyStart) + " ms");
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	...
	public void testStrees13() {
		...
		try {
			...
			long anyEnd = System.currentTimeMillis();
			System.out
					.println("this case[single client per thread(1thread * 300time=300)] take "
							+ (anyEnd - anyStart) + " ms");
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	...
	public void testStrees01() {
		...
		try {
			...
			long anyEnd = System.currentTimeMillis();
			System.out
					.println("this case[same client(30thread * 10time=300)] takes "
							+ (anyEnd - anyStart) + " ms");
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	...
	public void testStrees03() {
		...
		try {
			...
			long anyEnd = System.currentTimeMillis();
			System.out
					.println("this case[same client(10thread * 30time=300)] takes "
							+ (anyEnd - anyStart) + " ms");
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	...
	public void testStrees04() {
		...
		try {
			...
			long anyEnd = System.currentTimeMillis();
			System.out
					.println("this case[same client(1thread * 300time=300)] takes "
							+ (anyEnd - anyStart) + " ms");
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	...
	public void testStrees05() {
		...
		try {
			...
			long anyEnd = System.currentTimeMillis();
			System.out
					.println("this case[same client(60thread * 5time=300)] takes "
							+ (anyEnd - anyStart) + " ms");
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	...
	public void testStrees06() {
		...
		try {
			...
			long anyEnd = System.currentTimeMillis();
			System.out
					.println("this case[same client(150thread * 2time=300)] takes "
							+ (anyEnd - anyStart) + " ms");
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	...
	public void testStrees07() {
		...
		try {
			...
			long anyEnd = System.currentTimeMillis();
			System.out
					.println("this case[same client(300thread * 1time=300)] takes "
							+ (anyEnd - anyStart) + " ms");
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	...
	public void testStreesPut00() {
		...
		System.out.println("this case takes " + ts + " ms, the rate is "
				+ (1 * 10000000 / ts) + " p/s");
		...
		for (int i = 0; i < tc; i++) {
			Thread t = new Thread() {
				...
				public void run() {
					...
					for (int i = 0; i < 10000; i++) {
						try {
							client.putJob(1, 0, 5000,
									"this is some data".getBytes());
						} catch (Exception e) {
							e.printStackTrace();
						}
					}
